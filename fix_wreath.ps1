                ...
                <div class="relative group">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="text-center pb-2">
                            ...
                            <p class="text-[15px] font-bold text-zinc-900 leading-tight">Google for Media<br>Startups</p>
                        </div>
                        ' + $rightBranch + '
                    </div>
                </div>'
...
$regexGoogle = '(?s)<!-- Award 1: Google -->.*?<!-- Award 2: SK AI -->'
$html = $html -replace $regexGoogle, ("<!-- Award 1: Google -->" + $googleHtml + "

                <!-- Award 2: SK AI -->")

$regexSK = '(?s)<!-- Award 2: SK AI -->.*?</div>\s*</div>\s*</div>\s*<!-- Lectures Section -->'
$html = $html -replace $regexSK, ("<!-- Award 2: SK AI -->" + $skHtml + "
            </div>
